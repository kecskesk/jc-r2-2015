...
/**
 *  ExplodeCellResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ExplodeCellResponse implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://www.loxon.eu/CentralControl/",
            "explodeCellResponse", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":explodeCellResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "explodeCellResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ExplodeCellResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ExplodeCellResponse object = new ExplodeCellResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"explodeCellResponse".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ExplodeCellResponse) eu.loxon.www.centralcontrol.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
