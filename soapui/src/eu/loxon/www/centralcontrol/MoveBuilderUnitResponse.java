...
/**
 *  MoveBuilderUnitResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class MoveBuilderUnitResponse implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://www.loxon.eu/CentralControl/",
            "moveBuilderUnitResponse", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":moveBuilderUnitResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "moveBuilderUnitResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static MoveBuilderUnitResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            MoveBuilderUnitResponse object = new MoveBuilderUnitResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"moveBuilderUnitResponse".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (MoveBuilderUnitResponse) eu.loxon.www.centralcontrol.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
