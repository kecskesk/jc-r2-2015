...
/**
 *  StructureTunnelResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class StructureTunnelResponse implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://www.loxon.eu/CentralControl/",
            "structureTunnelResponse", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":structureTunnelResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "structureTunnelResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static StructureTunnelResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            StructureTunnelResponse object = new StructureTunnelResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"structureTunnelResponse".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (StructureTunnelResponse) eu.loxon.www.centralcontrol.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
